...
def guess_my_character(answer, key):
    ...
    if len(features) == 1:
        print("your character is "+features[0]["name"])
...
speak("Answer the questions and i will try to read your mind")
